...
- E<sub>m</sub> = fração de N<sub>t</sub> que germina e emerge
...
**N<sub>t+1</sub>**  = N<sub>t</sub> + [(N<sub>t</sub> \* <font color='red'>E<sub>m</sub></font> \* <font color='blue'>S<sub>pl</sub></font>) \* <font color='green'>P</sub></font> \* (1-<font color='green'>E<sub>f</sub></font>)] \* <font color='orange'>D</sub></font> - [(N<sub>t</sub> \* <font color='red'>E<sub>m</sub></font>) + ((N<sub>t</sub>-N<sub>t</sub> \* <font color='red'>E<sub>m</sub></font>) \* (1-<font color='purple'>S<sub>bs</sub></font>))] + I-E
...
- <font color='green'>P</sub></font> = número de sementes produzidas por planta
...
# Produção de sementes (sementes m<sup>-2</sup>)

.center[
N<sub>m</sub> \* P \* (1 - E<sub>f</sub>)
]
