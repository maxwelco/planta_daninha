...
knitr::include_graphics("https://media.giphy.com/media/30pdYnh6VSw5mWD0Z0/giphy.gif")
```
]

.pull-right[
```{r echo=FALSE, out.width=400, fig.align='center'}
knitr::include_graphics("https://media.giphy.com/media/cAtpnbVZzQweW3vFlA/giphy.gif")
```
]
...
knitr::include_graphics("https://media.giphy.com/media/T8ZP9P7efQ8cE/giphy.gif")
```
...
.pull-left[
```{r echo=FALSE, out.width=300, fig.align='center'}
knitr::include_graphics("https://media.giphy.com/media/EZRqJh9C8aMJG/giphy.gif")
```
]

.pull-left[
```{r echo=FALSE, out.width=300, fig.align='center'}
knitr::include_graphics("https://media.giphy.com/media/qjZLh6kL66nCw/giphy.gif")
```
]
...
knitr::include_graphics("https://media.giphy.com/media/26DNjBssHWaUSC60U/giphy.gif")
```
...
- O sucesso relativo com o qual um genótipo transmite seus genes para a próxima geração
    - Tolerância a herbivoria, aplicações de herbicidas