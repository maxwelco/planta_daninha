...
- O que mais você gostaria de saber sobre o desse produtor rutal?
...
```
---
# Modelos esquemáticos quantitativos
...
```{r scientific = FALSE}
N9 = 10 ^ 9 * 8
format(N9, scientific=F) # usaso para eliminar o número exponencial
```
